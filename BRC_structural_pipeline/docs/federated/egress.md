...
- The combination of 450 tract-specific values constitutes a **white matter fingerprint** that has been shown to uniquely identify individuals across scanning sessions.
...
- Melis, L. et al. (2019). Exploiting unintended feature leakage in collaborative learning. *IEEE Symposium on Security and Privacy*. [https://doi.org/10.1109/SP.2019.00029](https://doi.org/10.1109/SP.2019.00029)
